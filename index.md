...
header:
  ...
  text: >
    ...
    Stiamo lavorando a dei progetto Open Source, tra cui una app per il test della tecnologia bluetooth per il contact tracing, server per gestire i dati, un simulatore per valutare l'impatto dell'app.
  action:
